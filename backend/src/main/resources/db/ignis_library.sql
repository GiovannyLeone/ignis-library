...
-- PapiroTech | Versão 6.0 — MySQL 5.7
--
-- Apenas CREATE TABLE IF NOT EXISTS e INSERT IGNORE.
-- A lógica de ALTER TABLE (adicionar colunas/índices faltando)
-- é feita pelo DatabaseInitializer.java em Java via JDBC.
-- =============================================================
