...
public class EmprestimoService {
    ...
    public EmprestimoResponse gerarCodigoEmprestimo(Integer livroId, Cliente cliente) {
        ...
        Emprestimo emprestimo = Emprestimo.builder()
                .livro(livro)
                .cliente(cliente)
                .dataEmprestimo(LocalDateTime.now(ZONE_BR))
                .dataDevolucaoPrevista(LocalDate.now(ZONE_BR).plusDays(PRAZO_DIAS))
    ...
    public EmprestimoResponse gerarCodigoDevolucao(Integer emprestimoId, Cliente cliente) {
        ...
        boolean atrasado = LocalDate.now(ZONE_BR).isAfter(emprestimo.getDataDevolucaoPrevista());
    ...
    public EmprestimoResponse registrarDevolucao(String codigoDevolucao) {
        ...
        emprestimo.setDataDevolucaoReal(LocalDate.now(ZONE_BR));
